...
create table #alfa (Citta varchar(20), Modello varchar(20));
insert into #alfa values
('Milano', 'M01'),('Milano', 'M02'), ('Milano','M03')
;

create table #bravo (Citta varchar(20), Modello varchar(20));
insert into #bravo values
('Brescia', 'M01'),('Brescia', 'M02'), ('Brescia','M03')
;

create table #charlie (Citta varchar(20), Modello varchar(20));
insert into #charlie values
('Bologna', 'M01'),('Bologna', 'M02'), ('Brescia','M03')
;
GO

select Citta, Modello from #alfa
except 
select Citta, Modello from #bravo
intersect 
select Citta, Modello from #charlie
;
